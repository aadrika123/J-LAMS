...
//  */
const ApprovalView = () => {
    // State variables to store search input and debounced search value
    ...
    // Current page number (replace with your actual current page state or variable)
    // const currentPage = 1;
    ...
    //             url: 'https://aadrikainfomedia.com/auth/api/lams/v1/asset/get',
    //             method: 'GET',
    //             headers: {
    ...
    const fetchData = async () => {
        try {
            ...
            // Filter data to include only items with status 1
            const filteredData = res?.data?.data?.data.filter(item => item.status === 2) || [];
    ...
    // .........................................
    const fetchSearchData = async (page, searchQuery, filter) => {
        try {
            const res = await axios({
                url: `https://aadrikainfomedia.com/auth/api/lams/v1/asset/get?limit=7&page=${page}&search=${searchQuery}&filter=${filter}`,
    ...
    const { isLoading, error, data } = useQuery({
        ...
        queryFn: () => fetchSearchData(currentPage, debouncedSearch, filter),
        staleTime: 1000
    });
